...
export class AgentsPlugin extends Plugin implements ToolProvider {
  ...
  // keys (serving `name`, experiment `experimentId`, volume `path`), which TS
  // widens to an incompatible union on the JSON import. The shape is validated
  // at runtime against the plugin-manifest schema.
