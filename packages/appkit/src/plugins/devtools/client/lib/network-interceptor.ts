...
export function interceptNetwork(
  ...
  // Patch fetch
  if (!(window as any).__APPKIT_DEVTOOLS_FETCH_PATCHED__) {
    (window as any).__APPKIT_DEVTOOLS_FETCH_PATCHED__ = true;
  ...
  if (!(window as any).__APPKIT_DEVTOOLS_XHR_PATCHED__) {
    (window as any).__APPKIT_DEVTOOLS_XHR_PATCHED__ = true;
    ...
    XMLHttpRequest.prototype.open = function (
      ...
      (this as any).__appkitDevtoolsMeta = {
