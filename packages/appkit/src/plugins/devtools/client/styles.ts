...
.perf-row {
  display: grid;
  grid-template-columns: 48px 1fr 40px 64px;
  gap: 8px;
  align-items: center;
  padding: 6px 10px;
  border-radius: 8px;
...
.wf-row {
  display: grid;
  grid-template-columns: 40px 120px 1fr 52px 36px;
  gap: 6px;
  align-items: center;
  padding: 4px 8px;
  border-radius: 6px;
