 ...
 */
export type ExecutionContext = IServiceContext | IUserContext;

/**
 * Check if an execution context is a user context.
 */
export function isUserContext(ctx: ExecutionContext): ctx is IUserContext {
...
export class ServiceContext {
  private static instance: IServiceContext | null = null;
  private static initPromise: Promise<IServiceContext> | null = null;
   ...
   */
  static async initialize(): Promise<IServiceContext> {
  ...
  static createUserContext(
    ...
    console.log(
      `[ServiceContext] Created user context: userId=${userId}, tokenLength=${token.length}`,
    );
  ...
  private static async createContext(): Promise<IServiceContext> {
