...
import type { ExecutionContext, IUserContext } from "./service-context";
import { ServiceContext, isUserContext } from "./service-context";

/**
 * AsyncLocalStorage for execution context.
 * Used to pass user context through the call stack without explicit parameters.
 */
const executionContextStorage = new AsyncLocalStorage<IUserContext>();
 ...
 */
export function runInUserContext<T>(userContext: IUserContext, fn: () => T): T {
