...
This command will start the development server with hot reload for both UI Qackend code. Open the URL in your browser to see the app. Modify the code in the `src/` directory to see the changes reflected in the browser.
