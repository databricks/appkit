...
| [ServingEndpointRegistry](Interface.ServingEndpointRegistry.md) | Registry interface for serving endpoint type generation. Empty base — augmented by the type generator's `.d.ts` output via module augmentation. |
