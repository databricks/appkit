...
| [LakebasePlugin](Class.LakebasePlugin.md) | AppKit plugin for Databricks Lakebase Autoscaling. |
...
| [ServerPlugin](Class.ServerPlugin.md) | Server plugin for the AppKit. |
