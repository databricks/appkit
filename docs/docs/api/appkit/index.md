...
| [~~getLakebasePoolConfig~~](Function.getLakebasePoolConfig.md) | - |
| [getWorkspaceClient](Function.getWorkspaceClient.md) | Get workspace client from config or execution context |
