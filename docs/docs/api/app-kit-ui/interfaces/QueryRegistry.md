...
Defined in: [packages/app-kit-ui/src/react/hooks/types.ts:41](https://github.com/databricks/app-kit/blob/main/packages/app-kit-ui/src/react/hooks/types.ts#L41)
