...
Defined in: [packages/app-kit-ui/src/react/hooks/use-chart-data.ts:104](https://github.com/databricks/app-kit/blob/main/packages/app-kit-ui/src/react/hooks/use-chart-data.ts#L104)
