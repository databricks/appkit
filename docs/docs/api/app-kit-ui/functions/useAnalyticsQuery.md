...
Defined in: [packages/app-kit-ui/src/react/hooks/use-analytics-query.ts:50](https://github.com/databricks/app-kit/blob/main/packages/app-kit-ui/src/react/hooks/use-analytics-query.ts#L50)
